package com.app.airbom.controller;
...
import com.app.airbom.mapper.JYMapper;
import com.app.airbom.service.IGetService;
import com.app.airbom.service.IListService;
import com.app.airbom.service.IPostService;
...
public class JYController {
	...
	public @ResponseBody Map<?,?> addReservation(){
		...
		reservation.setCheckin(new Date("11/01/2017"));
		reservation.setCheckout(new Date("11/02/2017"));
